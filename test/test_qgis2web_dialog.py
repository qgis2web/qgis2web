...
#        self.dialog.buttonExport.click()
    ...
    def test82_OL3_WMS(self):
        """Dialog test: OL3 WMS"""
        layer_url = (
            'http://ogc.bgs.ac.uk/cgi-bin/BGS_Bedrock_and_Superficial_Geology/wms?contextualWMSLegend=0&crs=EPSG:3857&dpiMode=all&featureCount=10&format=image/png&layers=GBR_BGS_625k_BLT&styles=&')
