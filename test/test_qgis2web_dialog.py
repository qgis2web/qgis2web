...
class qgis2web_classDialogTest(unittest.TestCase):
    ...
    def test11_Leaflet_shp_pnt_categorized(self):
        ...
        project = QgsProject.instance()
        project.read(QFileInfo('/home/travis/build/tomchadwin/qgis2web/test_data/shp_point_categorized.qgs'))
        self.dialog.previewLeaflet()
    ...
    def test13_Leaflet_shp_pnt_graduated(self):
        ...
        project = QgsProject.instance()
        project.read(QFileInfo('/home/travis/build/tomchadwin/qgis2web/test_data/shp_point_graduated.qgs'))
        self.dialog.previewLeaflet()
    ...
    def test15_Leaflet_shp_line_simple(self):
        ...
        project = QgsProject.instance()
        project.read(QFileInfo('/home/travis/build/tomchadwin/qgis2web/test_data/shp_line_simple.qgs'))
        self.dialog.previewLeaflet()
    ...
    def test17_Leaflet_shp_line_categorized(self):
        ...
        project = QgsProject.instance()
        project.read(QFileInfo('/home/travis/build/tomchadwin/qgis2web/test_data/shp_line_categorized.qgs'))
        self.dialog.previewLeaflet()
    ...
    def test19_Leaflet_shp_line_graduated(self):
        ...
        project = QgsProject.instance()
        project.read(QFileInfo('/home/travis/build/tomchadwin/qgis2web/test_data/shp_line_graduated.qgs'))
        self.dialog.previewLeaflet()
    ...
    def test21_Leaflet_shp_polygon_simple(self):
        ...
        project = QgsProject.instance()
        project.read(QFileInfo('/home/travis/build/tomchadwin/qgis2web/test_data/shp_polygon_simple.qgs'))
        self.dialog.previewLeaflet()
    ...
    def test23_Leaflet_shp_polygon_categorized(self):
        ...
        project = QgsProject.instance()
        project.read(QFileInfo('/home/travis/build/tomchadwin/qgis2web/test_data/shp_polygon_categorized.qgs'))
        self.dialog.previewLeaflet()
    ...
    def test25_Leaflet_shp_polygon_graduated(self):
        ...
        project = QgsProject.instance()
        project.read(QFileInfo('/home/travis/build/tomchadwin/qgis2web/test_data/shp_polygon_graduated.qgs'))
        self.dialog.previewLeaflet()
