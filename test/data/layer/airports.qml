...
<qgis version="2.18.13" simplifyAlgorithm="0" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
  ...
  <customproperties>
    ...
    <property key="qgis2web/popup/ELEV" value="no label"/>
    <property key="qgis2web/popup/ID" value="no label"/>
    <property key="qgis2web/popup/NAME" value="no label"/>
    <property key="qgis2web/popup/USE" value="no label"/>
    <property key="qgis2web/popup/fk_region" value="no label"/>
