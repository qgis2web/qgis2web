...
<qgis simplifyDrawingTol="1" version="3.8.3-Zanzibar" minScale="1e+08" labelsEnabled="0" simplifyDrawingHints="1" simplifyMaxScale="1" readOnly="0" hasScaleBasedVisibilityFlag="0" simplifyAlgorithm="0" styleCategories="AllStyleCategories" simplifyLocal="1" maxScale="0">
  <flags>
  ...
  <DiagramLayerSettings showAll="1" obstacle="0" priority="0" zIndex="0" placement="2" linePlacementFlags="18" dist="0">
    <properties>
      <Option type="Map">
        <Option type="QString" value="" name="name"/>
        <Option name="properties"/>
  ...
  <constraints>
    ...
    <constraint notnull_strength="0" exp_strength="0" unique_strength="0" field="text" constraints="0"/>
  </constraints>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column type="field" hidden="0" name="text" width="-1"/>
