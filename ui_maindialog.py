...
class Ui_MainDialog(object):
    def setupUi(self, MainDialog):
        ...
        self.previewOnStartup = QtWidgets.QCheckBox(self.tab_3)
        ...
        self.closeFeedbackOnSuccess = QtWidgets.QCheckBox(self.tab_3)
        ...
        self.previewFeatureLimitLabel = QtWidgets.QLabel("Preview feature limit per layer: ", self.tab_3)
        self.previewFeatureLimit = QtWidgets.QLineEdit(self.tab_3)
