...
class Ui_MainDialog(object):
    ...
    def retranslateUi(self, MainDialog):
        ...
        self.previewOnStartup.setText(_translate("MainDialog", "Preview on startup", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MainDialog", "Settings", None))
